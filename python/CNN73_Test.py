...
# Load the model
new_model = tf.keras.models.load_model("models/CNN7030.h5")

# Load the history object
with open('models/CNN7030.pkl', 'rb') as f:
...
for batch in data_test.as_numpy_iterator():
    ...
    batch_loss = tf.keras.losses.sparse_categorical_crossentropy(y, yhat).numpy()
